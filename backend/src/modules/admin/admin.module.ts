...
@Module({
    imports: [
        TypeOrmModule.forFeature([Appointment, Product, Testimonial, GalleryVideo, BackgroundVideo, BlockedTime, Setting, BusinessHour]),
        AuthModule, // מספיק! כי AuthModule מייצא JwtModule
    ],
    controllers: [AdminAppointmentsController, AdminContentController, AdminController, BlockedTimesController, SettingsController, AdminBusinessHoursController],
})
