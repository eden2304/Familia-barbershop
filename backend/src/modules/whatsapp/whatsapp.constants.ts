export const WHATSAPP_TEMPLATES = {
    appointment_confirmed: {
        ...
        params: ['clientName', 'date', 'time', 'serviceName'] as const,
    },
    ...
    appointment_rescheduled: {
        ...
        params: ['clientName', 'oldDate', 'oldTime', 'newDate', 'newTime', 'serviceName'] as const,
    },
    ...
    admin_appointment_message: {
        ...
        params: ['clientName', 'date', 'time', 'serviceName', 'messageText'] as const,
    },
} as const;
