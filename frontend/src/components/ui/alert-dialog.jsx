...
const AlertDialogOverlay = React.forwardRef(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      // z-[200]: must sit above every in-app modal (several use z-[100], e.g. the
      // admin "add appointment" form), so a validation alert triggered from inside
      // one of those modals is never hidden behind it — see SystemPopupProvider.
